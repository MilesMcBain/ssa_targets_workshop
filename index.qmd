...
Targets is a framemork for building data science pipelines with R. It is part of
a growing niche of 'data orchestration' tools that conceive of data processing
pipelines as graph structures. What sets targets apart from the rest is its
incredible ergonomics, facilitated by features of the R programming language.
